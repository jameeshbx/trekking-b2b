                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                          toggleActiveStatus(itinerary.id, e.target.checked)
                        }
                      />
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Select value={statusDetails} onValueChange={(value: string) => setStatusDetails(value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setQuotationPrice(e.target.value)}
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <Select value={commissionType} onValueChange={(value: string) => setCommissionType(value)}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <input
                        type="text"
                        value={markupPrice}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMarkupPrice(e.target.value)}
                        readOnly
